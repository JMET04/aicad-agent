...
从 GitHub Releases 下载 `aicad-agent-1.3.2.zip` 和 `SHA256SUMS`，先核对 SHA-256，再解压。

```powershell
Get-FileHash .\aicad-agent-1.3.2.zip -Algorithm SHA256
```
...
基础 2D 编译只需要 Python 标准库。包装 DXF、预览和拓扑 QA 使用可选依赖：
