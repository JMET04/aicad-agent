...
同一个任务入口覆盖机械、电子/电气、包装、土木、建筑和钢结构，并按对象需要组织 2D、3D 与交互审查。覆盖表示任务能被识别、分流并受对应规则约束，不表示每个领域都具备同等级的自动设计或生产放行能力。

| 领域 | 当前可交付边界 |
|---|---|
| 机械 | 受控 2D/3D、技术包证据检查和哈希闭合的工厂 RFQ 候选；制造放行仍需专业与供应商复核 |
| 电子/电气 | KiCad/PCB 证据合同与原型制造候选；最终 ERC/DRC、CAM 和投板仍由真实 EDA 与人工放行 |
| 包装 | 受约束刀版生成、分层预览和交互复核；材料、刀模公差与量产工艺必须外部确认 |
| 建筑 | 受约束平面制图、语义线型线宽、原生尺寸和审查器；不替代施工图签章 |
| 土木 | 权威来源绑定的受约束审查候选；不提供生产级自动设计、专业签章或施工授权 |
| 钢结构 | 三维诊断、构件关系和跨专业来源绑定审查；不提供结构计算、节点设计或施工放行 |

因此，土木和钢结构的诊断/审查候选不能被表述为生产级自动设计；所有领域都继续遵守失败关闭和人工负责的授权边界。
...
v1.14.0 增加生成前规范门禁。机械任务必须逐项解析并来源绑定 54 条规则，电子任务必须逐项解析并来源绑定 63 条规则；缺项、多项、重复项、仅引用未解析、非法不适用、标准漂移、冲突或安全锁打开时，2D/3D 编译会在写出产物前失败。

v1.13.0 的非补偿式证据合同 v3 继续作为生成后门禁。机械门禁要求制造件和装配体的原生 CAD、STEP、制造图、BOM、材料、分析、检验与修订关系形成精确闭包；PCB 门禁要求每块板独立拥有 KiCad 工程、原理图、PCB、BOM、CPL、装配/制造图、3D 板、Gerber、PTH/NPTH 钻孔和 CAM 清单，并核对铜层与钻孔类别。
