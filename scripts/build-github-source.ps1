[CmdletBinding()]
param(
    [string]$OutputDirectory = 'release\v1.17.1\github-repository',
    [string]$Version = '1.17.1',
    [string]$PluginArchive = 'release\v1.17.1\aicad-agent-1.17.1.zip',
    [string]$PluginDirectory = 'release\v1.17.1\aicad-agent'
)
