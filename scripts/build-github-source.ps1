[CmdletBinding()]
param(
    [string]$OutputDirectory = 'release\v1.9.0\github-repository',
    [string]$Version = '1.9.0',
    [string]$PluginArchive = 'release\v1.9.0\aicad-agent-1.9.0.zip',
    [string]$PluginDirectory = 'release\v1.9.0\aicad-agent'
)
