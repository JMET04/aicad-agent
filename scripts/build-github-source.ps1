[CmdletBinding()]
param(
    [string]$OutputDirectory = 'release\v1.14.0\github-repository',
    [string]$Version = '1.14.0',
    [string]$PluginArchive = 'release\v1.14.0\aicad-agent-1.14.0.zip',
    [string]$PluginDirectory = 'release\v1.14.0\aicad-agent'
)
