[CmdletBinding()]
param(
    [string]$OutputDirectory = 'release\v1.17.2\github-repository',
    [string]$Version = '1.17.2',
    [string]$PluginArchive = 'release\v1.17.2\aicad-agent-1.17.2.zip',
    [string]$PluginDirectory = 'release\v1.17.2\aicad-agent'
)
