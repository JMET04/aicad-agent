...
class AgentPluginTests(unittest.TestCase):
    ...
    def test_capabilities_are_machine_readable(self) -> None:
        ...
        self.assertEqual(payload["api_version"], "1.15.0")
    ...
    def test_production_installer_preserves_verified_plugin_manifest(self) -> None:
        ...
        self.assertIn("[string]$ExpectedVersion = '1.15.0'", installer)
        self.assertLess(
            installer.index("release\\v1.15.0\\aicad-agent"),
        ...
        self.assertIn('EXPECTED_VERSION = "1.15.0"', verifier)
        ...
        with tempfile.TemporaryDirectory(dir=scratch_root) as temporary:
            ...
            completed = subprocess.run(
                [
                    ...
                    "-SourceDirectory", str(source), "-ExpectedVersion", "1.15.0",
                ],
                cwd=ROOT,
                text=True,
                encoding="utf-8",
