...
class AgentPluginTests(unittest.TestCase):
    ...
    def test_manifest_skill_and_mcp_are_complete(self) -> None:
        ...
        self.assertEqual(manifest["version"], "1.17.2")
    ...
    def test_capabilities_are_machine_readable(self) -> None:
        ...
        self.assertEqual(payload["api_version"], "1.17.2")
    ...
    def test_production_installer_preserves_verified_plugin_manifest(self) -> None:
        ...
        self.assertIn("[string]$ExpectedVersion = '1.17.2'", installer)
        self.assertLess(
            installer.index("release\\v1.17.2\\aicad-agent"),
        ...
        self.assertIn('EXPECTED_VERSION = "1.17.2"', verifier)
        ...
        with tempfile.TemporaryDirectory(dir=scratch_root) as temporary:
            ...
            completed = subprocess.run(
                [
                    ...
                    "-SourceDirectory", str(source), "-ExpectedVersion", "1.17.2",
                ],
                cwd=ROOT,
                text=True,
                encoding="utf-8",
